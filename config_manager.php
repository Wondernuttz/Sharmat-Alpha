...
<?php include __DIR__ . '/config_section_info.php'; ?>
    ...
    <script>
        ...
        function saveSettings() {
            ...
            if (document.getElementById('sceneCallMinAffinity')) formData.append('NSFW_SCENE_CALL_MIN_AFFINITY', document.getElementById('sceneCallMinAffinity').value);
            if (document.getElementById('playerSceneCallCooldown')) formData.append('NSFW_PLAYER_SCENE_CALL_COOLDOWN_SECONDS', document.getElementById('playerSceneCallCooldown').value);
            formData.append('TRACK_DRUNK_STATUS', document.getElementById('trackDrunkStatus').checked);
            formData.append('DRUNK_WINDOW_HOURS', document.getElementById('drunkWindowHours').value);
            formData.append('TRACK_FERTILITY_INFO', document.getElementById('trackFertilityInfo').checked);
            formData.append('CHILD_PROTECTION_FRAME', document.getElementById('childProtectionFrame').value);
            ...
            if (document.getElementById('nsfwAllowNpcJoinScenes')) formData.append('NSFW_ALLOW_NPC_JOIN_SCENES', document.getElementById('nsfwAllowNpcJoinScenes').checked);
            if (document.getElementById('nsfwAllowPaceControl')) formData.append('NSFW_ALLOW_PACE_CONTROL', document.getElementById('nsfwAllowPaceControl').checked);
            if (document.getElementById('nsfwAllowMidsceneSteering')) formData.append('NSFW_ALLOW_MIDSCENE_STEERING', document.getElementById('nsfwAllowMidsceneSteering').checked);
            if (document.getElementById('nsfwAffectionCooldownEnabled')) formData.append('NSFW_AFFECTION_COOLDOWN_ENABLED', document.getElementById('nsfwAffectionCooldownEnabled').checked);
            formData.append('NPC_SCENE_LLM_ENABLED', document.getElementById('npcSceneLlmEnabled').checked);
            formData.append('GROUP_SCENE_PARTICIPANT_DIALOGUE', document.getElementById('groupSceneParticipantDialogue').checked);
            formData.append('NPC_SCENE_CONTEXT_THROTTLE_SECONDS', document.getElementById('npcSceneContextThrottle').value);
            formData.append('NPC_SCENE_GLOBAL_COOLDOWN_SECONDS', document.getElementById('npcSceneGlobalCooldown').value);
            formData.append('NPC_SCENE_THREAD_COOLDOWN_SECONDS', document.getElementById('npcSceneThreadCooldown').value);
            formData.append('NPC_SCENE_ACTOR_COOLDOWN_SECONDS', document.getElementById('npcSceneActorCooldown').value);
            formData.append('NPC_SCENE_STALE_SECONDS', document.getElementById('npcSceneStaleSeconds').value);
            formData.append('NPC_SCENE_DISTANCE_PRIORITY_MARGIN', document.getElementById('npcSceneDistancePriorityMargin').value);
            formData.append('BLOCK_RECHAT_IN_SCENE', document.getElementById('blockRechatInScene').checked);
            formData.append('LEGACY_SCENE_SPEAK_POLICY', document.getElementById('legacySceneSpeakPolicy').value);
            formData.append('NSFW_EVENT_AUDIT_LOG', document.getElementById('nsfwEventAuditLog').checked);
            formData.append('SCENE_CONSENT_CARRYOVER_SECONDS', document.getElementById('sceneConsentCarryover').value);
            formData.append('WHISKEY_DICK_ENABLED', document.getElementById('whiskeyDickEnabled').checked);
            formData.append('WHISKEY_DICK_AUTO_END_SCENE', document.getElementById('whiskeyDickAutoEndScene').checked);
            formData.append('WHISKEY_DICK_BULLYING_ENABLED', document.getElementById('whiskeyDickBullyingEnabled').checked);
            formData.append('WHISKEY_DICK_CHANCE_3', document.getElementById('whiskeyDickChance3').value);
            formData.append('WHISKEY_DICK_CHANCE_4', document.getElementById('whiskeyDickChance4').value);
            formData.append('WHISKEY_DICK_CHANCE_5', document.getElementById('whiskeyDickChance5').value);
            formData.append('WHISKEY_DICK_CHANCE_6', document.getElementById('whiskeyDickChance6').value);
            if (document.getElementById('whiskeyDickDuration')) formData.append('NSFW_WHISKEY_DICK_DURATION_MINUTES', document.getElementById('whiskeyDickDuration').value);
            if (document.getElementById('whiskeyDickDrinkWindow')) formData.append('NSFW_PLAYER_DRUNK_WINDOW_MINUTES', document.getElementById('whiskeyDickDrinkWindow').value);
            ...
            formData.append('TOKEN_LIMIT_PHYSICS', document.getElementById('tokenLimitPhysics').value);
            // Cooldowns
            ...
            formData.append('PHYSICS_TOUCH_COOLDOWN', document.getElementById('physicsTouchCooldown').value);
            if (document.getElementById('physicsTouchSceneCooldown')) { formData.append('PHYSICS_TOUCH_SCENE_COOLDOWN', document.getElementById('physicsTouchSceneCooldown').value); }
            formData.append('PHYSICS_GRAB_COOLDOWN', document.getElementById('physicsGrabCooldown').value);
            formData.append('PHYSICS_LOW_CONFIDENCE_COOLDOWN', document.getElementById('physicsLowConfidenceCooldown').value);
            formData.append('PHYSICS_SUSTAINED_BREAST_TOUCH_SECONDS', document.getElementById('physicsSustainedBreastTouch').value);
            formData.append('PHYSICS_SPANK_ENABLED', document.getElementById('physicsSpankEnabled').checked);
            formData.append('PHYSICS_SPANK_MIN_SPEED', document.getElementById('physicsSpankMinSpeed').value);
            formData.append('PHYSICS_SPANK_COOLDOWN', document.getElementById('physicsSpankCooldown').value);
            // Slavery mechanics
            formData.append('SLAVERY_IDLES_ENABLED', document.getElementById('slaveryIdlesEnabled').checked);
            if (document.getElementById('slaveryAllowAskFreedom')) formData.append('SLAVERY_ALLOW_ASK_FREEDOM', document.getElementById('slaveryAllowAskFreedom').checked);
            formData.append('SLAVERY_AMBIENT_IDLES_ENABLED', document.getElementById('slaveryAmbientIdlesEnabled').checked);
            formData.append('SLAVERY_ACTION_IDLES_ENABLED', document.getElementById('slaveryActionIdlesEnabled').checked);
            formData.append('SLAVERY_HOME_SERVICE_IDLES', document.getElementById('slaveryHomeServiceIdles').checked);
            formData.append('SLAVERY_IDLE_CHANCE', document.getElementById('slaveryIdleChance').value);
            formData.append('SLAVERY_IDLE_COOLDOWN_SECONDS', document.getElementById('slaveryIdleCooldown').value);
            formData.append('SLAVERY_IDLE_ALIAS_MAP', document.getElementById('slaveryIdleAliasMap').value);
            formData.append('SLAVERY_TIER_IDLE_BONDED', document.getElementById('slaveryTierIdleBonded').value);
            formData.append('SLAVERY_TIER_IDLE_DEVOTED', document.getElementById('slaveryTierIdleDevoted').value);
            formData.append('SLAVERY_TIER_IDLE_FOND', document.getElementById('slaveryTierIdleFond').value);
            formData.append('SLAVERY_TIER_IDLE_FRIENDLY', document.getElementById('slaveryTierIdleFriendly').value);
            formData.append('SLAVERY_TIER_IDLE_ACQUAINTANCE', document.getElementById('slaveryTierIdleAcquaintance').value);
            formData.append('SLAVERY_TIER_IDLE_NEUTRAL', document.getElementById('slaveryTierIdleNeutral').value);
            formData.append('SLAVERY_TIER_IDLE_WARY', document.getElementById('slaveryTierIdleWary').value);
            formData.append('SLAVERY_TIER_IDLE_COLD', document.getElementById('slaveryTierIdleCold').value);
            formData.append('SLAVERY_TIER_IDLE_RESENTFUL', document.getElementById('slaveryTierIdleResentful').value);
            formData.append('SLAVERY_TIER_IDLE_HATEFUL', document.getElementById('slaveryTierIdleHateful').value);
            formData.append('SLAVERY_TIER_IDLE_HOSTILE', document.getElementById('slaveryTierIdleHostile').value);
            formData.append('SLAVERY_POISON_ENABLED', document.getElementById('slaveryPoisonEnabled').checked);
            formData.append('SLAVERY_POISON_SCENE_ONLY', document.getElementById('slaveryPoisonSceneOnly').checked);
            formData.append('SLAVERY_POISON_NOTIFY_PLAYER', document.getElementById('slaveryPoisonNotifyPlayer').checked);
            formData.append('SLAVERY_POISON_MIN_TIER', document.getElementById('slaveryPoisonMinTier').value);
            formData.append('SLAVERY_POISON_HATEFUL_CHANCE', document.getElementById('slaveryPoisonHatefulChance').value);
            formData.append('SLAVERY_POISON_HOSTILE_CHANCE', document.getElementById('slaveryPoisonHostileChance').value);
            formData.append('SLAVERY_POISON_SUCCESS_CHANCE', document.getElementById('slaveryPoisonSuccessChance').value);
            formData.append('SLAVERY_POISON_EXPIRE_GAME_HOURS', document.getElementById('slaveryPoisonExpireHours').value);
            formData.append('SLAVERY_POISON_COOLDOWN_GAME_HOURS', document.getElementById('slaveryPoisonCooldownHours').value);
            formData.append('SLAVERY_POISON_DURATION_SECONDS', document.getElementById('slaveryPoisonDurationSeconds').value);
            formData.append('SLAVERY_POISON_MAGNITUDE', document.getElementById('slaveryPoisonMagnitude').value);
            formData.append('SLAVERY_POISON_CONSUME_TYPES', document.getElementById('slaveryPoisonConsumeTypes').value);
            ...
            // Drunk physics
            formData.append('DRUNK_ANIMATIONS', document.getElementById('drunkAnimations').checked);
            formData.append('DRUNK_REQUIRE_MOVEMENT_FOR_STUMBLE', document.getElementById('drunkRequireMovement').checked);
            formData.append('DRUNK_STUMBLE_FORCE', document.getElementById('drunkStumbleForce').value);
            formData.append('DRUNK_STUMBLE_COOLDOWN_SECONDS', document.getElementById('drunkStumbleCooldown').value);
            formData.append('DRUNK_FALL_CHANCE_S6', document.getElementById('drunkFallChanceS6').value);
            formData.append('DRUNK_FALL_CHANCE_S7', document.getElementById('drunkFallChanceS7').value);
            formData.append('DRUNK_FALL_CHANCE_S8', document.getElementById('drunkFallChanceS8').value);
            formData.append('DRUNK_FALL_CHANCE_S9', document.getElementById('drunkFallChanceS9').value);
            formData.append('DRUNK_STANDING_FALL_CHANCE_S9', document.getElementById('drunkStandingFallChanceS9').value);
            formData.append('DRUNK_STUMBLE_CHANCE_S6', document.getElementById('drunkStumbleChanceS6').value);
            formData.append('DRUNK_STUMBLE_CHANCE_S7', document.getElementById('drunkStumbleChanceS7').value);
            formData.append('DRUNK_STUMBLE_CHANCE_S8', document.getElementById('drunkStumbleChanceS8').value);
            formData.append('DRUNK_STUMBLE_CHANCE_S9', document.getElementById('drunkStumbleChanceS9').value);
            formData.append('DRUNK_FALL_AFTER_DRINK_SECONDS', document.getElementById('drunkFallAfterDrink').value);
            // Drug system
            formData.append('DRUGS_ENABLED', document.getElementById('drugsEnabled').checked);
            formData.append('DRUG_ANIMATIONS', document.getElementById('drugAnimations').checked);
            formData.append('DRUG_REQUIRE_CONSUME_ACTION', document.getElementById('drugRequireConsumeAction').checked);
            formData.append('DRUG_WINDOW_HOURS', document.getElementById('drugWindowHours').value);
            formData.append('SAP_AUTO_ROUSE_SECONDS', document.getElementById('sapAutoRouseSeconds').value);
            formData.append('SKOOMA_L1_WEAROFF_HOURS', document.getElementById('skoomaL1Wearoff').value);
            formData.append('SKOOMA_L2_DECAY_HOURS', document.getElementById('skoomaL2Decay').value);
            formData.append('SKOOMA_L3_DETOX_HOURS', document.getElementById('skoomaL3Detox').value);
            formData.append('SKOOMA_TTS_TEMPO_1', document.getElementById('skoomaTempo1').value);
            formData.append('SKOOMA_TTS_TEMPO_2', document.getElementById('skoomaTempo2').value);
            formData.append('SKOOMA_TTS_TEMPO_3', document.getElementById('skoomaTempo3').value);
            formData.append('SAP_TTS_TEMPO', document.getElementById('sapTempo').value);
            formData.append('SKOOMA_SPEEDMULT', document.getElementById('skoomaSpeedmult').value);
            formData.append('SKOOMA_DANCE_CHANCE', document.getElementById('skoomaDanceChance').value);
            formData.append('SKOOMA_DANCE_COOLDOWN_SECONDS', document.getElementById('skoomaDanceCooldown').value);
            formData.append('SKOOMA_FIRST_IDLE_DELAY_SECONDS', document.getElementById('skoomaFirstIdleDelay').value);
            formData.append('SKOOMA_CRAZED_IDLE_COOLDOWN_SECONDS', document.getElementById('skoomaCrazedCooldown').value);
            formData.append('SKOOMA_POST_CONSUME_IDLE', document.getElementById('skoomaPostConsumeIdle').value);
            formData.append('SKOOMA_L1_IDLE_POOL', document.getElementById('skoomaL1IdlePool').value);
            formData.append('SKOOMA_L2_IDLE_POOL', document.getElementById('skoomaL2IdlePool').value);
            formData.append('SKOOMA_L3_IDLE_POOL', document.getElementById('skoomaL3IdlePool').value);
            formData.append('SKOOMA_DANCE_IDLE', document.getElementById('skoomaDanceIdle').value);
            formData.append('SKOOMA_CRAZED_IDLE', document.getElementById('skoomaCrazedIdle').value);
            formData.append('DRUG_OAR_VARIABLE', document.getElementById('drugOarVariable').value);
            formData.append('ALCOHOL_MATCH_TERMS', document.getElementById('alcoholMatchTerms').value);
            formData.append('SKOOMA_MATCH_TERMS', document.getElementById('skoomaMatchTerms').value);
            formData.append('SAP_MATCH_TERMS', document.getElementById('sapMatchTerms').value);
