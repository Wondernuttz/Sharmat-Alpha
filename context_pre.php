...
if (isset($GLOBALS["HERIKA_PERS"]) && $drunkStage < 1 && ($__lastPromptedDrunk > 0 || $__soberLeft > 0 || $__moodStillDrunk)) {
    ...
    $__finalStateLock .= "\n\n#FINAL CURRENT ALCOHOL STATE LOCK\nAlcohol has worn off. You are fully sober. Ignore drunk speech in memories, relationship summaries, your speech-style profile, and chat history - it is in the past. Your reported mood must NOT be drunk or tipsy - report a sober mood.";
